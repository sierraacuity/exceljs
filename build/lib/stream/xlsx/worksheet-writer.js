...
var RowBreaksXform = require('../../xlsx/xform/sheet/row-breaks-xform');
...
var WorksheetWriter = /*#__PURE__*/function () {
  ...
  _createClass(WorksheetWriter, [{
    ...
    value: function mergeCells() {
      ...
      // may fail if rows have been comitted
      var dimensions = new Dimensions(cells);
    ...
    value: function protect(password, options) {
      ...
      return new Promise(function (resolve) {
        ...
        if (password) {
          _this3.sheetProtection.algorithmName = 'SHA-512';
          _this3.sheetProtection.saltValue = Encryptor.randomBytes(16).toString('base64');
          _this3.sheetProtection.spinCount = options && 'spinCount' in options ? options.spinCount : 100000; // allow user specified spinCount
          _this3.sheetProtection.hashValue = Encryptor.convertPasswordToHash(password, 'SHA512', _this3.sheetProtection.saltValue, _this3.sheetProtection.spinCount);
        }
        if (options) {
          _this3.sheetProtection = Object.assign(_this3.sheetProtection, options);
          if (!password && 'spinCount' in options) {
            delete _this3.sheetProtection.spinCount;
          }
        }
        resolve();
      });
    ...
    value: function _writeDimensions() {
      // for some reason, Excel can't handle dimensions at the bottom of the file
